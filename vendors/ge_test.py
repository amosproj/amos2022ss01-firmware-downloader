...
class testing(unittest.TestCase):
    ...
    def test_case_without_authentication(self):
        ...
        self.assertEqual(dest, gt_file_path, msg='path not same')
    ...
    def test_case_with_authentication():
        ...
        try:
            ...
            raise ValueError(f"{e}")
        gt_file_path = os.path.join(dest, file_name)
        download_file(gt_url, gt_file_path, data[0], data[1], folder, file_name, 'javascript:;', gt_url,
                      "Passport_DownloadFile('SDSeries',7,70);return false")
        print("Test Passed")
